...
export default function Home() {
    ...
    const posts = useMemo(() => normalizeList(postsRaw), [postsRaw]);
    const programs = useMemo(() => normalizeList(progsRaw), [progsRaw]);
    useEffect(() => {
        (async () => {
            try {
                setApiFailed(false);
                /* ---------- 1) 최신 모집글(3) ---------- */
                const postsRes = await api.get("/api/recruitments/search", {
                ...
                const rawPosts = Array.isArray(postsRes?.data?.content)
                    ...
                    : Array.isArray(postsRes?.data)
                        ? postsRes.data
                        : [];
                const mappedPosts = rawPosts.slice(0, 3).map((r) => {
    ...
    return (_jsxs("div", { className: "grid gap-10", children: [_jsx(ImageSlider, { slides: [
                ...
                ], heightClass: "h-[220px] sm:h-[300px] md:h-[360px]", rounded: "rounded-3xl", autoplayMs: 4500, className: "shadow-lg" }), _jsx("section", { className: "intro-strip rounded-2xl border border-[var(--c-card-border)] bg-gradient-to-b from-white to-[var(--c-bg2)] p-6 shadow-sm", children: _jsxs("div", { className: "flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between", children: [_jsxs("div", { children: [_jsx("h3", { className: "text-xl font-bold", children: "\uC774\uC74C \u2014 \uCCAD\uB144\u00B7\uB300\uD559\uC0DD\uC744 \uC704\uD55C \uC62C\uC778\uC6D0 \uCC3D\uC5C5 \uD50C\uB7AB\uD3FC" }), _jsx("p", { className: "mt-1 text-sm muted", children: "\uD300 \uB9E4\uCE6D, \uACF5\uC720\uC624\uD53C\uC2A4, \uC9C0\uC6D0\uC0AC\uC5C5 \uC815\uBCF4\uB97C \uD55C \uACF3\uC5D0\uC11C. \uB9C8\uAC10 \uC54C\uB9BC\uAE4C\uC9C0 \uAE54\uB054\uD558\uAC8C \uCC59\uACA8\uB4DC\uB824\uC694." }), _jsxs("div", { className: "mt-3 flex flex-wrap gap-2", children: [_jsx("span", { className: "badge", children: "\uBB34\uB8CC\uB85C \uC2DC\uC791" }), _jsx("span", { className: "badge", children: "\uB9C8\uAC10 \uC784\uBC15 \uC54C\uB9BC" }), _jsx("span", { className: "badge", children: "\uB0B4 \uADFC\uCC98 \uACF5\uC720\uC624\uD53C\uC2A4" }), _jsx("span", { className: "badge", children: "\uB7EC\uBE0C\uCF5C \uAD00\uB9AC" })] })] }), _jsxs("div", { className: "flex gap-2", children: [_jsx(Link, { to: "/teams", className: "no-underline", children: _jsx(Button, { children: "\uD300 \uB458\uB7EC\uBCF4\uAE30" }) }), _jsx(Link, { to: "/programs", className: "no-underline", children: _jsx(Button, { variant: "outline", children: "\uC9C0\uC6D0\uC0AC\uC5C5 \uBCF4\uAE30" }) })] })] }) }), _jsx("section", { className: "rounded-2xl border border-[var(--c-card-border)] bg-white p-6", children: _jsxs("div", { className: "grid grid-cols-2 gap-6 text-center md:grid-cols-4", children: [_jsxs("div", { className: "kpi", children: [_jsx("div", { className: "kpi__num", children: "2,100+" }), _jsx("div", { className: "kpi__label", children: "\uB4F1\uB85D\uB41C \uBAA8\uC9D1\uAE00" })] }), _jsxs("div", { className: "kpi", children: [_jsx("div", { className: "kpi__num", children: "850+" }), _jsx("div", { className: "kpi__label", children: "\uACF5\uC720\uC624\uD53C\uC2A4" })] }), _jsxs("div", { className: "kpi", children: [_jsx("div", { className: "kpi__num", children: "1,300+" }), _jsx("div", { className: "kpi__label", children: "\uC9C0\uC6D0\uC0AC\uC5C5\u00B7\uB300\uD68C" })] }), _jsxs("div", { className: "kpi", children: [_jsx("div", { className: "kpi__num", children: "98%" }), _jsx("div", { className: "kpi__label", children: "\uC774\uC6A9\uC790 \uB9CC\uC871\uB3C4" })] })] }) }), _jsxs("div", { className: "grid gap-4 md:grid-cols-3", children: [_jsxs("div", { className: "card glass hover:lift", children: [_jsx("h3", { className: "font-semibold", children: "\uD300 \uB9E4\uCE6D & \uB7EC\uBE0C\uCF5C" }), _jsx("p", { className: "muted mt-1 text-sm", children: "\uB9DE\uCDA4 \uCE74\uB4DC \uD0D0\uC0C9 \u00B7 \uBCF4\uB0B8/\uBC1B\uC740 \uB7EC\uBE0C\uCF5C \uAD00\uB9AC" }), _jsx(Link, { to: "/teams", className: "mt-3 inline-block no-underline", children: _jsx(Button, { children: "\uD300 \uCC3E\uAE30" }) })] }), _jsxs("div", { className: "card glass hover:lift", children: [_jsx("h3", { className: "font-semibold", children: "\uACF5\uC720\uC624\uD53C\uC2A4" }), _jsx("p", { className: "muted mt-1 text-sm", children: "\uAC00\uACA9/\uD3B8\uC758\uC2DC\uC124 \uD544\uD130 \u00B7 \uCE74\uB4DC\uD615 \uBCF4\uAE30 \u00B7 \uC9C0\uB3C4 \uBBF8\uB9AC\uBCF4\uAE30" }), _jsx(Link, { to: "/spaces", className: "mt-3 inline-block no-underline", children: _jsx(Button, { variant: "outline", children: "\uACF5\uAC04 \uD0D0\uC0C9" }) })] }), _jsxs("div", { className: "card glass hover:lift", children: [_jsx("h3", { className: "font-semibold", children: "\uC9C0\uC6D0\uC0AC\uC5C5\u00B7\uB300\uD68C" }), _jsx("p", { className: "muted mt-1 text-sm", children: "\uC804\uAD6D \uC815\uBCF4 \uBAA8\uC544\uBCF4\uAE30 \u00B7 \uB9C8\uAC10 \uC784\uBC15 \uC21C \uC815\uB82C" }), _jsx(Link, { to: "/programs", className: "mt-3 inline-block no-underline", children: _jsx(Button, { variant: "outline", children: "\uC9C0\uC6D0\uC0AC\uC5C5 \uBCF4\uAE30" }) })] })] }), _jsxs(Section, { title: "\uCD5C\uC2E0 \uBAA8\uC9D1\uAE00", desc: "\uBC29\uAE08 \uC62C\uB77C\uC628 \uD300\uC744 \uBA3C\uC800 \uB9CC\uB098\uBCF4\uC138\uC694", moreHref: "/recruitments", children: [loading ? (_jsx("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3", children: Array.from({ length: 3 }).map((_, i) => (_jsxs("div", { className: "rounded-2xl border border-[var(--c-card-border)] bg-white p-4", children: [_jsx("div", { className: "skeleton h-5 w-3/4" }), _jsxs("div", { className: "mt-3 flex gap-2", children: [_jsx("div", { className: "skeleton h-4 w-16" }), _jsx("div", { className: "skeleton h-4 w-24" }), _jsx("div", { className: "skeleton h-4 w-12" })] })] }, i))) })) : (_jsxs("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3", children: [posts.slice(0, 3).map((p) => (_jsx(Link, { to: `/recruitments/${p.id}`, className: "no-underline", children: _jsxs("article", { className: "flex h-56 cursor-pointer flex-col justify-between rounded-2xl border border-[var(--c-card-border)] bg-white p-4 shadow-sm transition hover:shadow-md", children: [_jsxs("div", { children: [_jsx("h3", { className: "mb-2 line-clamp-2 text-base font-semibold text-[var(--c-text)] hover:brand", children: p.title }), _jsxs("div", { className: "flex flex-wrap items-center gap-x-3 gap-y-1 text-xs muted", children: [_jsxs("span", { children: ["\uD83D\uDCCD ", fmtRegion(p.region)] }), _jsxs("span", { children: ["\uD83D\uDC64 ", p.author ?? "-"] }), _jsxs("span", { children: ["\uD83C\uDFF7 ", fmtExp(p)] })] })] }), _jsx("div", { className: "mt-3 flex items-center justify-end", children: ddayBadge(p.deadline ?? undefined, p.alwaysOpen) })] }) }, p.id))), posts.length === 0 && _jsx("div", { className: "muted", children: "\uD45C\uC2DC\uD560 \uBAA8\uC9D1\uAE00\uC774 \uC5C6\uC2B5\uB2C8\uB2E4." })] })), apiFailed && _jsx("p", { className: "mt-2 text-xs text-amber-600", children: "\uC2E4\uC2DC\uAC04 \uB370\uC774\uD130\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD574 \uC608\uC2DC \uB370\uC774\uD130\uB97C \uD45C\uC2DC\uD558\uACE0 \uC788\uC5B4\uC694." })] }), _jsx(AdBanner, { href: "#", imageUrl: "/banners/adbanner.jpg", className: "w-full", height: 180 }), _jsxs(Section, { title: "\uB9C8\uAC10 \uC784\uBC15 \uC9C0\uC6D0\uC0AC\uC5C5", desc: "\uC624\uB298 \uB193\uCE58\uBA74 \uC544\uC26C\uC6B4 \uD61C\uD0DD", moreHref: "/programs", children: [loading ? (_jsx("ul", { className: "grid gap-2", children: Array.from({ length: 6 }).map((_, i) => (_jsx("li", { className: "rounded-xl bg-white px-4 py-3 ring-1 ring-[var(--c-card-border)]", children: _jsx("div", { className: "skeleton h-4 w-2/3" }) }, i))) })) : (_jsxs("ul", { className: "grid gap-2", children: [programs.map((p) => (_jsxs("li", { className: "flex items-center justify-between rounded-xl bg-white px-4 py-3 ring-1 ring-[var(--c-card-border)] transition hover:bg-white/90", children: [_jsx(Link, { to: `/programs/${p.id}`, className: "truncate no-underline text-[var(--c-text)] hover:brand", children: p.title }), _jsxs("span", { className: "flex items-center gap-2 text-xs muted", children: [_jsx("span", { children: p.provider ?? "" }), _jsx(ProgramDday, { p: p })] })] }, p.id))), programs.length === 0 && _jsx("li", { className: "muted", children: "\uD45C\uC2DC\uD560 \uD56D\uBAA9\uC774 \uC5C6\uC2B5\uB2C8\uB2E4." })] })), apiFailed && _jsx("p", { className: "mt-2 text-xs text-amber-600", children: "\uC2E4\uC2DC\uAC04 \uB370\uC774\uD130\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD574 \uC608\uC2DC \uB370\uC774\uD130\uB97C \uD45C\uC2DC\uD558\uACE0 \uC788\uC5B4\uC694." })] }), _jsxs("div", { className: "grid gap-4 md:grid-cols-3", children: [_jsx(AdBanner, { href: "#", imageUrl: "/banners/adbanner.jpg" }), _jsx(AdBanner, { href: "#", imageUrl: "/banners/adbanner.jpg" }), _jsxs("div", { className: "card glass flex flex-col justify-center", children: [_jsx("h3", { className: "text-lg font-semibold", children: "\uC9C0\uAE08 \uC2DC\uC791\uD574 \uBCF4\uC138\uC694" }), _jsx("p", { className: "muted mt-1 text-sm", children: "\uBAA8\uC9D1\uAE00 \uC791\uC131, \uACF5\uAC04 \uB4F1\uB85D, \uC774\uB825\uC11C \uC5C5\uB85C\uB4DC\uAE4C\uC9C0 \uD55C \uBC88\uC5D0" }), _jsxs("div", { className: "mt-3 flex gap-2", children: [_jsx(Link, { to: "/teams/new", className: "no-underline", children: _jsx(Button, { children: "\uBAA8\uC9D1\uAE00 \uC791\uC131" }) }), _jsx(Link, { to: "/spaces/new", className: "no-underline", children: _jsx(Button, { variant: "outline", children: "\uACF5\uAC04 \uB4F1\uB85D" }) })] })] })] })] }));
}
