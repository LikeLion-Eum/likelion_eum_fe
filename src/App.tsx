...
import SentLoveCalls from "@/pages/my/SentLoveCalls";
import ReceivedLoveCalls from "./pages/my/ReceivedLoveCalls";
          ...
          <main className="mx-auto max-w-6xl px-4 py-6">
            <ErrorBoundary>
              <Routes>
                ...
                <Route path="/my/lovecalls" element={<ReceivedLoveCalls />} />
                <Route path="/my/lovecalls/sent" element={<SentLoveCalls />} />
